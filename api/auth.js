  ...
  try {
    ...
    try {
      ...
      return res.status(500).json({ 
        ...
        hint: 'Check BLOB_READ_WRITE_TOKEN in Vercel settings'
      });
    }
    ...
    if (action === 'signup') {
      ...
      const isAdmin = username === 'THErealadmin' && password === 'BRUno-2026';
      ...
      if (!isAdmin) {
        try {
          ...
          await put(`brumessenger-admin-notifications/${username}-${Date.now()}.json`, 
